...
import 'package:bowerbird_messaging_app/core/models/message_group.dart' as _i9;
...
class MockMessageService extends _i1.Mock implements _i8.MessageService {
  ...
  @override
  _i4.Future<List<_i9.MessageGroup>?> getMessageGroups(bool? isLoggedIn) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMessageGroups,
          [isLoggedIn],
        ),
        returnValue: _i4.Future<List<_i9.MessageGroup>?>.value(),
